 ...
 * аннотация», прецедент {@code @EntityMetadata.searchable}). Остальные модули
...
class FormDeadApiTest {
     ...
     */
    private static final int MIN_WHITELIST = 2;
    ...
    private static final Map<String, String> WHITELIST = new LinkedHashMap<>(Map.of(
            // Глобальный поиск (каталог паттернов) — единственный будущий потребитель
            // флага searchable; до его дизайна флаг удерживается как декларация намерения.
            "org.ipro.metadata.annotation.EntityMetadata",
            "searchable: резерв под глобальный поиск (П3: «потребитель или удаление — решить до разморозки»)",
