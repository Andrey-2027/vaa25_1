 ...
 *
 * <p>Прикладной провайдер может заменить generic JPA-провайдер для конкретной сущности
 * (например, когда появится специализированный индекс), но обычная декларация источника
 * работает без второй регистрации: используется bounded JPA-fallback.</p>
 */
