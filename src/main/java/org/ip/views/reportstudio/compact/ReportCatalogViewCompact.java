 ...
 */
@Route("report-catalog-compact")
@PageTitle("Каталог отчётов (компакт)")
@PermitAll
public class ReportCatalogViewCompact extends HorizontalLayout {

    private final ReportTemplateService templateService;
    private final ReportTemplateTransferService transferService;
    private final ReportEditorViewCompact editor;
    private final Grid<ReportTemplate> grid = new Grid<>(ReportTemplate.class, false);
    private final TextField search = new TextField();

    public ReportCatalogViewCompact(
