...
public class NomAttributeValue extends BaseEntity implements HasDisplayName {
     ...
     * узел в дереве подсистем не создаётся, а типизированного сервиса у класса нет —
     * автономный data handle такому классу не резолвится. Заголовки и {@code selectColumns} в
