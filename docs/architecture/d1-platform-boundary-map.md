...
Первый срез D2 выполнен и записан отдельно: [`d2-contracts-extraction.md`](d2-contracts-extraction.md)
(вынесен пакет `org.ipro.metadata.annotation`, 12 типов). Ниже — что именно D1 передал в D2.
